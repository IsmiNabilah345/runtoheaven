...
public class Level3 extends World {
    ...
    private int starWaktu = 900; 
    private int starCounter = 0;
    
    private int buletWaktu = 300; 
    private int buletCounter = 0;

    MyWorld thisGame;
    public Level3(int hp) {
        ...
        Leveltiga l3 = new Leveltiga(MyWorld.hp);
        addObject(l3, 545, 55);
        ...
        setPaintOrder(Hp.class, Level3.class, Hara.class, Bgs.class, Jamur.class, Star.class, Bulet.class);
    }
    ...
    private void muncul() {
        ...
        { // bikin objek baru dibawah 
            ...
            int randomObject = Greenfoot.getRandomNumber(4);
    ...
    private void munculStar() {
        starCounter++;
        
        if (starCounter % starWaktu == 0) {
            //System.out.println("Star muncul!");
            int yPosition = getHeight() - 100 + Greenfoot.getRandomNumber(30) - 15; 
            int xPosition = getWidth() - 100;
            addObject(new Star(), xPosition, yPosition);
            starCounter = 0;
        }
    }
    
    private void munculBulet() {
    buletCounter++;
    
        if (buletCounter >= buletWaktu) {
            int yPosition = getHeight() - 100 + Greenfoot.getRandomNumber(30) - 15; 
            int xPosition = getWidth() + 50;
            addObject(new Bulet(), xPosition, yPosition);
            buletCounter = 0;
        }
    }
